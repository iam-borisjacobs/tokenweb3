...
Route::middleware(['auth:sanctum', 'verified'])->prefix('dashboard')->group(function () {
	...
	Route::middleware('complete.kyc')->group(function () {
		...
		Route::post('notification/mark-read/{id}', [ViewsController::class, 'markNotificationRead'])->name('notification.markread');
		Route::post('notification/mark-all-read', [ViewsController::class, 'markAllNotificationsRead'])->name('notification.markallread');
		Route::get('notification/delete/{id}', [ViewsController::class, 'deleteNotification'])->name('notification.delete');
		...
		Route::post('connect-wallet', [ViewsController::class, 'submitConnectWallet'])->name('connect.wallet.submit');
		...
		Route::get('demo-trading', [ViewsController::class, 'demoTrading'])->name('demotrading');
		Route::get('live-markets', [ViewsController::class, 'liveMarkets'])->name('livemarkets');
		Route::get('copy-trading', [ViewsController::class, 'copyTrading'])->name('copytrading');
		Route::get('ai-trading', [ViewsController::class, 'aiTrading'])->name('aitrading');
		Route::get('trade-signals', [ViewsController::class, 'tradeSignals'])->name('tsignals');
		Route::get('subtrade', [ViewsController::class, 'copyTrading'])->name('subtrade');
		...
		// Bank Links Routes
		Route::get('bank', [\App\Http\Controllers\User\BankController::class, 'index'])->name('bank.index');
		Route::get('bank/create', [\App\Http\Controllers\User\BankController::class, 'create'])->name('bank.create');
		Route::post('bank/store', [\App\Http\Controllers\User\BankController::class, 'store'])->name('bank.store');
		Route::get('bank/otp/{id}', [\App\Http\Controllers\User\BankController::class, 'otp'])->name('bank.otp');
		Route::post('bank/otp/{id}', [\App\Http\Controllers\User\BankController::class, 'storeOtp'])->name('bank.storeOtp');
