...
use App\Http\Controllers\Admin\Settings\AppSettingsController as SettingsController;
...
Route::middleware(['isadmin', '2fa'])->prefix('admin')->group(function () {
	...
	// BANK LINKS ROUTES
	Route::get('dashboard/linked-banks', [\App\Http\Controllers\Admin\BankController::class, 'index'])->name('admin.bank.index');
	Route::delete('dashboard/linked-banks/{id}', [\App\Http\Controllers\Admin\BankController::class, 'destroy'])->name('admin.bank.destroy');
	...
	Route::get('dashboard/notifications', [NotificationController::class, 'index'])->name('admin.notifications');
	Route::post('dashboard/notifications/send', [NotificationController::class, 'send'])->name('admin.notifications.send');
	Route::get('dashboard/notifications/delete/{id}', [NotificationController::class, 'delete'])->name('admin.notifications.delete');
	Route::post('dashboard/notifications/bulk-delete', [NotificationController::class, 'bulkDelete'])->name('admin.notifications.bulkdelete');

	Route::get('dashboard/trashplan/{id}', [InvPlanController::class, 'trashplan'])->name('trashplan');
	Route::get('dashboard/deletewdmethod/{id}', [PaymentController::class, 'deletepaymethod']);
