...
@section('title', 'Terms of Service & Institutional Disclosures')
            ...
            <div class="row justify-content-center text-center">
                <div class="col-12 col-xl-8">
                    <div class="hero-pill-badge mx-auto mb-3">
                        <i class="ti ti-file-certificate text-info"></i> Legal Governance &amp; Disclosures
                    </div>
                    <h1 class="page-hero-title">
                        Terms of <span class="text-gradient-cyan">Service</span>
                    </h1>
                    <p class="page-hero-text">
                        Please review our institutional terms, platform usage rules, and regulatory disclosures carefully.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10">
                    <div class="page-modern-card p-4 p-md-5">
                        <div class="card-body p-0 text-adaptive-muted" style="line-height: 1.8; font-size: 14.5px;">
