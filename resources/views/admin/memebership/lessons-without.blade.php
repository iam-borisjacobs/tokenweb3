    ...
    <div class="row mb-4 align-items-center justify-content-between g-3">
        <div class="col-md-7">
            ...
            <h3 class="f-w-800 text-dark mb-1">
                <i class="fa-solid fa-layer-group text-primary me-2"></i> Standalone Lessons (Categorized)
            </h3>
            <p class="text-muted mb-0 f-13">Manage standalone training modules organized directly under topic categories without a parent course.</p>
        </div>
        <div class="col-md-auto d-flex align-items-center gap-2">
            <button class="btn btn-primary rounded-pill px-4 py-2 f-13 f-w-700 shadow-sm" type="button" data-bs-toggle="modal" data-bs-target="#newLessonModal">
                <i class="fa-solid fa-plus me-1"></i> Add Standalone Lesson
            </button>
        </div>
    </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 rounded-3 overflow-hidden d-flex flex-column">
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between flex-grow-1">
                        <div>
                            <h6 class="f-w-700 text-dark mb-2">{{ $less->title }}</h6>
                    ...
                    <div class="modal-content border-0 shadow-lg">
                        ...
                        <form method="POST" action="{{ route('updatedlesson') }}" enctype="multipart/form-data">
                            ...
                            <div class="modal-body p-4">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="form-label f-w-600 f-12">Category <span class="text-danger">*</span></label>
                                        <select name="category" class="form-select form-control" required>
                                            @foreach ($categories as $cat)
                                                <option value="{{ $cat->category }}" {{ $less->category == $cat->category ? 'selected' : '' }}>
                                                    {{ $cat->category }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12">
                                        <label class="form-label f-w-600 f-12">Video Stream URL <span class="text-danger">*</span></label>
                    ...
                    <div class="modal-content border-0 shadow-lg p-3">
                        <div class="modal-body pt-4">
                            ...
                            <p class="text-muted f-13 mb-4">
                                Are you sure you want to delete lesson <strong>{{ $less->title }}</strong>?
                            </p>
        ...
        @empty
            <div class="col-12">
                <div class="card p-5 text-center shadow-sm border-0 rounded-3">
                    ...
                    <h5 class="f-w-700 text-dark mb-1">No Standalone Lessons</h5>
                    <p class="text-muted f-13 mb-4">You have not created any lessons without an assigned course parent.</p>
...
<div class="modal fade" id="newLessonModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header border-bottom pb-3">
                <h5 class="modal-title f-w-700 text-dark">
                    <i class="fa-solid fa-plus text-primary me-2"></i> Add Standalone Lesson
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form method="POST" action="{{ route('addlesson') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label f-w-600 f-12">Video Duration <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="length" placeholder="e.g. 15m 30s" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label f-w-600 f-12">Lesson Title <span class="text-danger">*</span></label>
                        ...
                        <div class="col-12">
                            <label class="form-label f-w-600 f-12">Description <span class="text-danger">*</span></label>
                            <textarea name="desc" rows="4" class="form-control" placeholder="Lesson overview..." required></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label f-w-600 f-12">Thumbnail (File)</label>
                            <input type="file" class="form-control" name="image">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label f-w-600 f-12">Or Thumbnail URL</label>
